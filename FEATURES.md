...
[Accounting/FEATURES.md](Accounting/FEATURES.md) / [shared/FEATURES.md](shared/FEATURES.md)。

| ID | 機能 | 状態 | 実装/定義 | 関連要件 |
|---|---|---|---|---|
| FEAT-MR01 | 複数プロジェクト構成(Magi / TradeCouncil / Accounting / shared)とルーター CLAUDE | 実装済 | [CLAUDE.md](CLAUDE.md) | REQ-MR01 |
