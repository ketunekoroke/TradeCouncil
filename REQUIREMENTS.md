...
[Accounting/REQUIREMENTS.md](Accounting/REQUIREMENTS.md) / [shared/REQUIREMENTS.md](shared/REQUIREMENTS.md)。
...
| REQ-MR02 | 各プロジェクト(`Magi` / `TradeCouncil` / `Accounting`)は相互非依存。いずれのディレクトリを削除しても他は動作する(疎結合の保証) | 必須 | 実装済 |
