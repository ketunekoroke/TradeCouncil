...
> モノレポ再編(ADR-0011・全体は [../BACKLOG.md](../BACKLOG.md) の MR-001)で TradeCouncil は
> 1プロジェクトになった。シナリオ・人格・ブリッジの項目は [../Magi/BACKLOG.md](../Magi/BACKLOG.md) /
> [../shared/BACKLOG.md](../shared/BACKLOG.md)。**BL-039(prototype 削除)は再編で完了**。
